...
<html>
	<head>
		...
		<link rel="stylesheet" href="/home_us/css/safety.css" />
	</head>
	<body>
		<!--header 开始-->
		<div class="myheader">
			<div class="myheader_con">
				...
				<span class="mytitle">Security verification</span>
			</div>
		</div>
		<!--header 结束-->
		<div class="safety_con">
			<div class="img">
				<img src="/home_us/images/safety_iocn2.png"/>
				<img src="/home_us/images/safety_iocn3.png" style="display: none;"/>
			</div>
			<p>For your account security, this login needs to be verified.<br/>Please move the icon below to the round area</p>
			<div class="safety_cz">
				<img id="safety" src="/home_us/images/safety_iocn1.png">
				<span></span>
			</div>
		</div>
	</body>
